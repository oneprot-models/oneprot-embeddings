...
PDB_TRAIN_CSV      = 'ASD_original_split/train_df_pdb.csv'
PDB_TEST_CSV       = 'ASD_original_split/test_df_pdb.csv'
PDB_TRAIN_TEXT_CSV = 'ASD_original_split/train_df_pdb_text.csv'
PDB_TEST_TEXT_CSV  = 'ASD_original_split/test_df_pdb_text.csv'
