...
Usage:
    python plot_balanced_vs_unbalanced_roc.py \
        ...
        --output_dir     /p/project1/hai_oneprot/bazarova1/oneprot-panda/balanced_vs_unbalanced_roc
"""
...
def main():
    ...
    parser.add_argument(
        "--output_dir",
        default="/p/project1/hai_oneprot/bazarova1/oneprot-panda/balanced_vs_unbalanced_roc",
    )
